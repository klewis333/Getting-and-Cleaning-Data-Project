...
* Input relevant data files as tables
* Merge rows for same variable type
* Name variables for concatenated files
* Merge all data into a data frame
* Extract means and sds for each measure and subset by selected aspects
* Rename variables with descriptive names
* Merge into small cleaned data set
